...
public class ClienteServiceImpl implements ClienteService {
    ...
    @Override
    @Transactional
    public void save(Cliente cliente) { //Este método sirve para guardar y para actualizar
        //***Si el idCliente es 0, lo inserta, si tiene algún valor hace update de ése registro
